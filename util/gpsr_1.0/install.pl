#==================================================================
# This scipt allow you to install gpsr package in desired directory
#==================================================================
...
###    'gpsr_base_1.0' is free software package: you can redistribute it and/or 
...
$gpsr_home=`pwd`;
#$gpsr_perl=`which perl`;
#$gpsr_svm_classify=`which svm_classify`;
#$gpsr_svm_classify_old=`which svm_classify`;
#$gpsr_blast=``;
#$gpsr_blastpgp=`blastpgp`;
#$gpsr_psipred=`which psipred`;
#$gpsr_psidata=``;
#$gpsr_hmmer=``;
#$gpsr_meme=`which meme`;
#$gpsr_mast=`which mast`;
...
print "Enter svm_classify path of SVM_light version 6.01 package<$gpsr_svm_classify>:";
$str = <>;
if(length($str) >= 3){$gpsr_svm_classify=$str}

print "Enter svm_classify path of old version(5.0) of SVM_light package<$gpsr_svm_classify_old>:";
$str = <>;
...
print "Enter blastpgp command of blast package <$gpsr_blastpgp>:";
$str = <>;
if(length($str) >= 3){$gpsr_blastpgp=$str}

print "Enter makemat command (IMPALA) of blast package <$gpsr_makemat>:";
$str = <>;
...
print "Enter path for hmmpfam HMMER package <$gpsr_hmmpfam>:";
$str = <>;
if(length($str) >= 3){$gpsr_hmmpfam=$str}

print "Enter path for hmmsearch of HMMER package <$gpsr_hmmsearch>:";
$str = <>;
if(length($str) >= 3){$gpsr_hmmsearch=$str}

print "Enter path for hmmbuild HMMER package <$gpsr_hmmbuild>:";
$str = <>;
...
print "\nInstallation Started! Please WAIT for some time to complete the installation process...............................................\n";
...
print FP "\$gpsr_hmmbuild=\"$gpsr_hmmsearch\";\n";
...
print "\nCongratulations! package succeessfully installed!\n\n";
